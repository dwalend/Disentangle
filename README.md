...
* Added [parallel versions](TODO) of Dijkstra's and Brandes' algorithms for all shortest paths.
* Restructured into subprojects to minimize dependencies on third-party libraries in your code
** Added an [example subproject](TODO) and [benchmark subproject](TODO)
